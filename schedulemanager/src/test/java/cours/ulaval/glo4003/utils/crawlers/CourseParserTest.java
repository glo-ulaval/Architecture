...
public class CourseParserTest {
	...
	private static final String A_TITLE_NOT_IN_DEPARTEMENT = "PHI 3900 - Éthique et professionnalisme";
	...
	@Test
	public void doesNotParseCourseIfCourseIsNotInDepartement() {
		prepareDescription(A_COMPLETE_DESCRIPTION);
		prepareTitle(A_TITLE_NOT_IN_DEPARTEMENT);

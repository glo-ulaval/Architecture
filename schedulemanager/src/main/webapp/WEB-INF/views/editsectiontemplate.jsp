            ...
            <div class="span9 controls classes">
              <c:choose>
                <c:when test="${not empty section.days}">
                  ...
                  <div class="hours">
                    <c:forEach var="day" items="${section.days}"
                      varStatus="status">
                      ...
                      <input type="text" placeholder="HH:MM" class="input-small"
                        name="timeSlotStarts"
                        value="${section.timeSlotStarts[status.index]}" />
                    &agrave; <input type="text" placeholder="HH:MM"
                        class="input-small" name="timeSlotEnds"
                        value="${section.timeSlotEnds[status.index]}" />
                      <br />
                    </c:forEach>
                  </div>
                </c:when>
                ...
                <c:choose>
                  <c:when test="${not empty section.labDay}">
                    ...
                    <input type="text" placeholder="HH:MM" class="input-small"
                      ...
                      value="${section.laboTimeSlotStart}"> à <input
                      type="text" placeholder="HH:MM" class="input-small"
                      name="laboTimeSlotEnd" value="${section.laboTimeSlotEnd}">
                  </c:when>

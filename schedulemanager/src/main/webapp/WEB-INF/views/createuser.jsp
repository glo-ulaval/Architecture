		...
		<div class="row-fluid">
			...
			<table class="table table-striped">
				...
				<tr>
					...
					<td id = "permissions"><span class="per"></span><select class="input-large" name="permissions"
						value="${selected}">
					...
					<a class="btn btn-success addRole" onClick=addRole()><i
          class="icon-plus-sign icon-white"></i></a></span></td>
				</tr>
			</table>
		</div>
    <c:url var="menurl" value="/menu"></c:url>
    <a class="btn btn-success pull-right" href="${menurl}">Créer</a>
	</div>
